...
> ✅ Проверено на **Apple TV 4K (3-го поколения, 2022)**, tvOS 26.4
...
[ATVLoadly](https://github.com/bitxeno/atvloadly) — самохостящийся Docker-контейнер с веб-интерфейсом для сайдлоада напрямую на Apple TV. Инструкция по установке и настройке — в репозитории проекта.
